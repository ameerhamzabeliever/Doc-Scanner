...
final class EditScanViewController: UIViewController {
    ...
    private lazy var nextButton: UIBarButtonItem = {
        let title = NSLocalizedString("Next", tableName: nil, bundle: Bundle(for: EditScanViewController.self), value: "Next", comment: "A generic next button")
    ...
    private lazy var cancelButton: UIBarButtonItem = {
        let title = NSLocalizedString("Cancel", tableName: nil, bundle: Bundle(for: EditScanViewController.self), value: "Cancel", comment: "A generic cancel button")
    ...
    override public func viewDidLoad() {
        ...
        setupViews()
        setupConstraints()
        title = NSLocalizedString("Edit Scan", tableName: nil, bundle: Bundle(for: EditScanViewController.self), value: "Edit Scan", comment: "The title of the EditScanViewController")
