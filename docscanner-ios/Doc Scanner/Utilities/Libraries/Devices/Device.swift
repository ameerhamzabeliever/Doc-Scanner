//
//  DeviceDetectorExtenstion.swift
//  Artfora
//
//  Created by Appcrates Dev on 2/4/20.
//  Copyright © 2020 Jimmy Knudsen. All rights reserved.
//
...
public enum DevicesType: String, CaseIterable {
    case iPhone2G
    ...
    public static var current: DevicesType {
        ...
        return DevicesType(identifier: identifier)
    }
    ...
    internal init(identifier: String) {
        ...
        for device in DevicesType.allCases {
...
public extension UIDevice {
    ...
    var deviceType: DevicesType {
        return DevicesType.current
    }
}
