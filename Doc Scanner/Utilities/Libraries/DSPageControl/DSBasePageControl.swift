...
@IBDesignable open class DSBasePageControl: UIControl, DSPageControllable {
    
    open weak var delegate: DSBasePageControlDelegate?
...
public protocol DSBasePageControlDelegate: class {
    func didTouch(pager: DSBasePageControl, index: Int)
}
