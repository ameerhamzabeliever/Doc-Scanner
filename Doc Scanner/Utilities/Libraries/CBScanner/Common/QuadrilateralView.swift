...
final class QuadrilateralView: UIView {
    ...
    public var editable = false {
        didSet {
            ...
            quadLayer.fillColor = editable ? #colorLiteral(red: 0.1803921569, green: 0.7647058824, blue: 0.9882352941, alpha: 0.5).cgColor : #colorLiteral(red: 0.1803921569, green: 0.7647058824, blue: 0.9882352941, alpha: 0.5).cgColor
    ...
    private var isHighlighted = false {
        didSet (oldValue) {
            ...
            quadLayer.fillColor = isHighlighted ? #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0).cgColor : #colorLiteral(red: 0.1803921569, green: 0.7647058824, blue: 0.9882352941, alpha: 0.5).cgColor
    ...
    private let cornerViewSize            = CGSize(width: 13.0, height: 13.0)
